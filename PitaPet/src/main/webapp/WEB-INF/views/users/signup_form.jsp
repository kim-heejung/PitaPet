...
<div class="container">
	...
	<div id="petusers">
		...
		<form action="${pageContext.request.contextPath}/users/signup.do" method="post" id="myForm">
			...
			<div>
				...
				<input class="" type="tel" name="phoneNumber1" id="phoneNumber1"/>-
				<input class="" type="tel" name="phoneNumber2" id="phoneNumber2" />-
				<input class="" type="tel" name="phoneNumber3" id="phoneNumber3" />
			</div>
			<div>
	...
	<button class="btn btn-primary changeBtn" type="submit">회원/기관</button>
</div>

<script src="${pageContext.request.contextPath}/resources/js/gura_util.js"></script>

<script>
	let changeBtn = document.querySlector('changeBtn');
	let changeForm = document.querySlector('petusers');
	
	changeBtn.addEventListener('click', () =>{
		changeBtn.value= 'shelter';
	});
</script>
<script>
