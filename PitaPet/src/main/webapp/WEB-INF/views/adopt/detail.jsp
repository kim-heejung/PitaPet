	...
	<div id="adoptUpdate">
		...
		<div class="board-wrap">
			...
			<div class="container">
							...
							<c:otherwise>
								<c:choose>
									<c:when test="${like.liked eq 'yes' }">
										<p>
											<a style="color: red;"
												href="${pageContext.request.contextPath}/api/adoptlike/unlike.do?num=${dto.num }">♥</a>
										</p>
									</c:when>
									<c:otherwise>
										<p>
											<a style="color: red;"
												href="${pageContext.request.contextPath}/adoptlike/like.do?num=${dto.num }">♡</a>
										</p>
									</c:otherwise>
								</c:choose>
							</c:otherwise>
				...
				<nav>
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="">목록보기</a></li>
						<c:if test="${dto.writer eq id }">
							<li><a
								href="${pageContext.request.contextPath}/adopt/private/updateform.do?num=${dto.num }">수정</a></li>
							<li><a
								href="${pageContext.request.contextPath}/api/adopt/delete.do?num=${dto.num }">삭제</a></li>
						</c:if>
					</ul>
				</nav>
				<nav>
				...
				<button>
					<a href="${pageContext.request.contextPath}/reserve/private/insertform.do">상담예약</a>
				</button>
			</div>
		</div>
