      ...
      <ul class="pagination justify-content-center">
         <c:choose>
         	<c:when test="${dto.prevNum ne 0 }">
         		<li class="page-item mr-3">
               		<a class="page-link" href="${pageContext.request.contextPath}/adopt/detail.do?num=${dto.prevNum}&animalType=${animalType}">&larr; Prev</a>
            	</li>
         	</c:when>
         	<c:otherwise>
         ...
         <c:choose>
         	<c:when test="${dto.nextNum ne 0 }">
         		<li class="page-item">
               		<a class="page-link" href="${pageContext.request.contextPath}/adopt/detail.do?num=${dto.nextNum}&animalType=${animalType}">Next &rarr;</a>
            	</li>
         	</c:when>
         	<c:otherwise>
