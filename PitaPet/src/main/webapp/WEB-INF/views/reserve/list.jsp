					...
					<tbody>
						<tr class="boardRow" v-for="(tmp, index) in reserveList">
							...
							<td class="boardColumn contentTitle">
								<a v-if="id == tmp.id && tmp.scope == 'private'" class="contentTitleLink" :href="cpath + '/reserve/detail.do?num=' + tmp.num">
								...
								<a v-if="tmp.scope != 'private'" class="contentTitleLink" :href="cpath + '/reserve/detail.do?num=' + tmp.num">
									{{ tmp.title }}
								</a>
